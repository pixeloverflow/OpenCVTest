...
void drawSquares( IplImage* img, CvSeq* squares )
{
    ...
    for( i = 0; i < squares->total; i += 4 )
    {
        ...
        cvPolyLine( cpy, &rect, &count, 1, 1, CV_RGB(255,255,255), 10, CV_AA, 0 );
    }
    
    // show the resultant image
    cvShowImage( wndname, cpy );
    cvSaveImage("/Users/XiaoJiaKai/Desktop/nykeyboard4test.jpg", cpy);
    cvReleaseImage( &cpy );
}

IplImage* test(IplImage* img)
{
    ...
    Mat img2;
    Mat inputArray = img1;
    cv::bitwise_xor(inputArray,Scalar(255),img2);
    IplImage* img3;
    *img3 =IplImage(img2);
    IplImage* img4 = img3;
    return img4;
...
int main(int argc, char** argv)
{
    ...
    const char* imagename = "/Users/XiaoJiaKai/Desktop/11.png";
